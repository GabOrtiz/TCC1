<%-- 
    Document   : filtromsg
    Created on : 28/09/2014, 13:16:22
    Author     : Ortiz
--%>
        ...
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column centralizado">
                    ...
                    <form role="form" action="./inicial.jsp">
                        <br>
                        <br>
                        <br>
                        <br>
                        <br>
                        <button type="submit" class="btn btn-danger">Você não tem permissão para acessar este conteúdo, 
                            clique para voltar para a página inicial</button>
                    </form>
                </div>
