<%-- 
    Document   : logs
    Created on : 11/06/2015, 05:38:38
    Author     : Ortiz
--%>
            ...
            <div class="row clearfix">
                <div class="col-md-6 column centralizado">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href='registros.jsp'>Registros</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-footer">
                            <span class="pull-left">
                                <%
                                    List<Sensor> mov = new ArrayList<Sensor>();
                                    mov = sdao.visualizarSUID(id, "movimento");
                        ...
                        <div class="panel-footer">
                            <span class="pull-left">
                                <%
                                    ...
                                    temp = sdao.visualizarSUID(id, "temperatura");
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-footer">
                            <span class="pull-left">
                                <%
                                    List<Sensor> umi = new ArrayList<Sensor>();
                                    umi = sdao.visualizarSUID(id, "umidade");
